<template>
  <div class="mb-16">
    <div class="">
      <h2 class="text-3xl font-bold">What can I do for you?</h2>
      <ul class="mt-8 list-disc ml-8 font-medium opacity-75 space-y-4">
        <li>
          <p>
        ...
        <li>
          <p>
            I can offer you advice about infrastructure decisions, and manage a
            variety of solutions available out there.
          </p>
        </li>
      </ul>
    </div>
